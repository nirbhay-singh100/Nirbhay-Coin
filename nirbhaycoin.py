...
# Creating an address forthe node on port 5000
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Nirbhay', amount = 1)
...
def is_valid():
    ...
    if check:
        ...
        response = {'message' : 'Houston, we have a proble, the Blockchain is not valid'}
    return jsonify(response), 200
